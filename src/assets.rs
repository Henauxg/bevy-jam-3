...
pub const DEPRECATED_AVERAGE_PILLAR_WIDTH: f32 = 5. * TILE_SIZE;
pub const DEPRECATED_AVERAGE_PILLAR_HEIGHT: f32 = 8. * TILE_SIZE;
pub const DEPRECATED_HALF_AVERAGE_PILLAR_HEIGHT: f32 = DEPRECATED_AVERAGE_PILLAR_HEIGHT / 2.;

pub const VISIBLE_ROD_LENGTH: f32 = 1.0;
pub const HALF_VISIBLE_ROD_LENGTH: f32 = VISIBLE_ROD_LENGTH / 2.;
pub const MOVABLE_ROD_LENGTH: f32 = DEPRECATED_AVERAGE_PILLAR_WIDTH + 1.05 * VISIBLE_ROD_LENGTH; // So that it is always visible from both sides
...
pub const PYLON_VERTICAL_MOVEMENT_AMPLITUDE: f32 = TILE_SIZE / 2.;
pub const PYLON_RADIUS: f32 = 0.15;
pub const PYLON_HEIGHT: f32 = PYLON_VERTICAL_MOVEMENT_AMPLITUDE * 2.;
pub const PYLON_ANIMATION_DURATION: u64 = 2000;
pub const WIN_PYLON_HEIGHT: f32 = TILE_SIZE;
pub const WIN_PYLON_ANIMATION_DURATION: u64 = 3500;
